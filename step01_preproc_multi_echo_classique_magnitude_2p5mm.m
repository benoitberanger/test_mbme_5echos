...
% % Anat
e.addSerie('T1w_for2p5mm$', 'anat_T1', 1 );
e.getSerie('anat').addVolume('^v_.*nii','v',1);


e.addSerie('me3_2_5mm_TR1880ms_p2_mb3_mag$'          , 'run_3echos_2.5mm', 1);
e.addSerie('me3_2_5mm_TR1880ms_p2_mb3_mag_PhysioLog$', 'phy_3echos_2.5mm', 1);
e.getSerie('run_3echos').addVolume('^v_.*nii$', 'v', 3);

e.addSerie('me5_2_5mm_TR1880ms_p2_mb4_mag$'               , 'run_5echos_2.5mm', 1);
e.addSerie('me5_2_5mm_TR1880ms_p2_mb4_mag_PhysioLog$'     , 'phy_5echos_2.5mm', 1);
e.getSerie('run_5echos').addVolume('^v_.*nii$', 'v', 5);

e.getSerie('phy').addPhysio('dcm$', 'dcm', 1);

% ep2d_se : distortion correction
e.addSerie('ep2d_se_forward_SBRef$', 'se_forward', 1);
e.addSerie('ep2d_se_reverse_SBRef$', 'se_reverse', 1);
